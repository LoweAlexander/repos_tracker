...
:: Find tracked_repos.txt gist and get its ID
for /f "tokens=1" %%I in (`gh gist list --limit 100 ^| findstr "tracked_repos.txt"`) do set "GIST_ID=%%I"
...
>>>>>>> 79f570a (Auto-sync DESKTOP-TKPFG84 13/03/2026 2-34-02.36)
